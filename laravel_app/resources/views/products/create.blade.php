...
@section('content')
    <h1 class="h4 mb-2">Tambah Produk</h1>
    <p class="text-muted small mb-3">Pilih <strong>Kategori</strong> dan <strong>Satuan</strong> dari dropdown, atau klik <strong>+ Baru</strong> untuk menambah lewat jendela popup tanpa keluar halaman.</p>

    <div class="app-mobile-pad-bottom">
    <div class="card shadow-sm">
        <div class="card-body">
            <form id="formProduk" action="{{ route('products.store') }}" method="POST" class="vstack gap-3">
                @csrf
                ...
                <div class="mb-0">
                    ...
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <div class="form-text">Dipakai saat jenis harga <strong>Bal</strong> di kasir: penjualan qty bal × isi ini = pcs yang keluar dari stok.</div>
                </div>
                <p class="form-text small mb-3">Di kasir, harga dipilih per jenis: Eceran, Grosir, atau Bal.</p>
    ...
    <div class="sticky-actions-mobile d-md-none">
        <div class="d-grid gap-2">
            <button type="submit" form="formProduk" class="btn btn-primary btn-lg w-100">Simpan</button>
