...
@section('content')
    ...
    <!-- Report Inventory Card Section -->
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-header bg-white py-3 border-bottom">
            <h5 class="fw-bold mb-0 text-dark"><i class="bi bi-file-earmark-bar-graph-fill text-primary me-1"></i> REPORT INVENTORY</h5>
        </div>
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-12 col-md-6">
                    <div class="card border border-light-subtle h-100 shadow-none bg-light bg-opacity-10">
                        <div class="card-body d-flex flex-wrap align-items-center justify-content-between gap-2">
                            <div>
                                <h6 class="fw-bold text-dark mb-1">1. Laporan 10 Produk Terlaris</h6>
                                <p class="text-muted small mb-0">Laporan rangking produk paling laku berdasarkan qty terjual.</p>
                            </div>
                            <div class="d-flex gap-2">
                                <a href="{{ route('owner.reports', ['report_type' => 'terlaris']) }}" class="btn btn-outline-primary btn-sm d-inline-flex align-items-center gap-1">
                                    <i class="bi bi-eye"></i> Preview
                                </a>
                                <a href="{{ route('owner.reports.pdf', ['report_type' => 'terlaris']) }}" class="btn btn-outline-danger btn-sm d-inline-flex align-items-center gap-1">
                                    <i class="bi bi-file-pdf"></i> PDF
                                </a>
                                <a href="{{ route('owner.reports.export.excel', ['report_type' => 'terlaris']) }}" class="btn btn-outline-success btn-sm d-inline-flex align-items-center gap-1">
                ...
                <!-- 2. Laporan Daftar Semua Produk -->
                <div class="col-12 col-md-6">
                    <div class="card border border-light-subtle h-100 shadow-none bg-light bg-opacity-10">
                        <div class="card-body d-flex flex-wrap align-items-center justify-content-between gap-2">
                            <div>
                                <h6 class="fw-bold text-dark mb-1">2. Laporan Daftar Semua Produk</h6>
                                <p class="text-muted small mb-0">Daftar lengkap katalog semua produk beserta spesifikasi harga &amp; kemasan.</p>
                            </div>
                            <div class="d-flex gap-2">
                                <a href="{{ route('owner.reports', ['report_type' => 'produk']) }}" class="btn btn-outline-primary btn-sm d-inline-flex align-items-center gap-1">
                                    <i class="bi bi-eye"></i> Preview
                                </a>
                                <a href="{{ route('owner.reports.pdf', ['report_type' => 'produk']) }}" class="btn btn-outline-danger btn-sm d-inline-flex align-items-center gap-1">
                                    <i class="bi bi-file-pdf"></i> PDF
                                </a>
                                <a href="{{ route('owner.reports.export.excel', ['report_type' => 'produk']) }}" class="btn btn-outline-success btn-sm d-inline-flex align-items-center gap-1">
                                    <i class="bi bi-file-excel"></i> Excel
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-12 col-md-6">
                    <div class="card border border-light-subtle h-100 shadow-none bg-light bg-opacity-10">
                        <div class="card-body d-flex flex-wrap align-items-center justify-content-between gap-2">
                            <div>
                                <h6 class="fw-bold text-dark mb-1">3. Laporan Produk Perlu Restok</h6>
                                <p class="text-muted small mb-0">Daftar produk yang stoknya telah mencapai or di bawah batas minimum.</p>
                            </div>
                            <div class="d-flex gap-2">
                                <a href="{{ route('owner.reports', ['report_type' => 'restok']) }}" class="btn btn-outline-primary btn-sm d-inline-flex align-items-center gap-1">
                                    <i class="bi bi-eye"></i> Preview
                                </a>
                                <a href="{{ route('owner.reports.pdf', ['report_type' => 'restok']) }}" class="btn btn-outline-danger btn-sm d-inline-flex align-items-center gap-1">
                                    <i class="bi bi-file-pdf"></i> PDF
                                </a>
                                <a href="{{ route('owner.reports.export.excel', ['report_type' => 'restok']) }}" class="btn btn-outline-success btn-sm d-inline-flex align-items-center gap-1">
                                    <i class="bi bi-file-excel"></i> Excel
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-12 col-md-6">
                    <div class="card border border-light-subtle h-100 shadow-none bg-light bg-opacity-10">
                        <div class="card-body d-flex flex-wrap align-items-center justify-content-between gap-2">
                            <div>
                                <h6 class="fw-bold text-dark mb-1">4. Laporan Persediaan Barang</h6>
                                <p class="text-muted small mb-0">Laporan status ketersediaan barang, stok, dan klasifikasi keamanan stok.</p>
                            </div>
                            <div class="d-flex gap-2">
                                <a href="{{ route('owner.reports', ['report_type' => 'persediaan']) }}" class="btn btn-outline-primary btn-sm d-inline-flex align-items-center gap-1">
                                    <i class="bi bi-eye"></i> Preview
                                </a>
                                <a href="{{ route('owner.reports.pdf', ['report_type' => 'persediaan']) }}" class="btn btn-outline-danger btn-sm d-inline-flex align-items-center gap-1">
                                    <i class="bi bi-file-pdf"></i> PDF
                                </a>
                                <a href="{{ route('owner.reports.export.excel', ['report_type' => 'persediaan']) }}" class="btn btn-outline-success btn-sm d-inline-flex align-items-center gap-1">
                                    <i class="bi bi-file-excel"></i> Excel
                                </a>
                            </div>
                        </div>
